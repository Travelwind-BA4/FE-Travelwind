...
const Profile = () => {
    ...
    return(
        <div className="bg-[#f1f5f5] px-10 py-4 rounded-lg">
            ...
            <h1 className="flex items-center text-xl"><FiUser className="mr-4"/> Profile</h1>
            <button onClick={() => setShowEdit(true)} className={showEdit ? 'hidden' : 'mr-4 font-medium hover:text-[#ffba51] text-[#df9947]'} >
                Edit
            </button>
            </div>
                ...
                >
                    ...
                    >
                        ...
                        <div className="flex justify-end my-4 gap-4 mr-4">
                            <button onClick={() => setShowEdit(false)} className="px-5 py-2 text-[18px] leading-[25px] border-none rounded-lg bg-[#df9947] text-white">
                                Cancel
                            </button>
                            <button className="px-7 py-2 text-[18px] leading-[25px] border-none rounded-lg bg-[#3e5cb8] text-white">Save</button>
                        </div>
