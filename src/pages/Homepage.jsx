...
import { BsCalendarDate, BsSearch, BsCalendar4Event } from "react-icons/bs";
import { promotion_1 } from "../assets/images/home";
    ...
    <div className>
      ...
      <section className="my-20">
        <div className="container mx-auto">
          <h1 className="text-center text-4xl font-semibold text-[#59595b]">Why Flight Ticket</h1>
          <div className="grid grid-cols-3 mt-20 gap-y-20 justify-items-center">
      ...
      <section className="bg-[#f1f5f5] mt-20">
        <div className="container mx-auto py-20">
          ...
          <div className="grid grid-cols-3 gap-x-10 mt-10 ">
            <div className="col-span-1 bg-[#fff]  flex justify-center items-center text-center rounded-full min-h-[650px]">
              <div>
                <div className="flex justify-center">
                  <div className="flex justify-center bg-[#3e5cb8] text-white py-10 rounded-full min-w-[150px]">
      ...
      <section className="my-20">
        <div className="container mx-auto">
          <h1 className="text-2xl font-medium">Recommended for you</h1>
        </div>
      </section>
    </div>
  );
