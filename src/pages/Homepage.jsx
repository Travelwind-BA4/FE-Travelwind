...
const Homepage = () => {
  ...
  const searchFlight = ({
    ...
    navigate(
      `results/search?depDate=${timeConverter(
        departureDate
      )}&depAirport=${departureAirport}&arrAirport=${arrivalAirport}&traveler=${traveler}`
    );
  };
  ...
  return (
    <>
      <section className="relative sm:mb-[250px] mb-[450px]">
        <Navbar
          nav="absolute top-0 w-full z-10 text-white"
          notif="text-white"
        />
        <div className="h-[75vh] header">
          <div
            className=" bg-header bg-cover brightness-[0.85] w-full h-full absolute top-0"
            style={{ backgroundImage: `url(${header_1})`, zIndex: "-2" }}
          ></div>
          ...
          <div className="flex justify-center">
            <div className="border-2 rounded-xl shadow-md bg-[#fff] absolute sm:bottom-[-140px] bottom-[-400px] px-10 py-3 mx-5 lg:min-w-[800px] ">
              ...
              <div className="flex justify-center">
                <Form
                  className="grid xl:grid-cols-4 sm:grid-cols-2 grid-cols-1 gap-5 my-8 px-2"
                ...
                >
                  <div className="flex items-center">
                    ...
                    <div className="pl-2">
                      <div>
                        <h1 className="text-lg font-medium pl-3">
                          Location From
                        </h1>
                        <Options
                          placeholder="Soekarno Hatta ( JKT ) "
                  ...
                  <div className=" flex items-center">
                    ...
                    <div className="pl-8 hidden lg:block">
                      <button
                        className="btn-active p-4 rounded-full"
                        type="submit"
                      >
                  ...
                  <div className="col-span-1 sm:col-span-2 lg:hidden">
                    <button
                      className="btn-active w-full p-4 rounded-full"
                      type="submit"
                    >
                      Search
                    </button>
        ...
        <div className="container mx-auto px-10">
          <div className="text-center mb-14">
            ...
            <p className="text-[#cfcfcf]">
              Here you will find all our luxorious tour packages in a reasonable
              range of cost
            </p>
          </div>
          <Homeslider />
      ...
      <section className="bg-[#DCE2E5] mt-20">
        <div className="container mx-auto py-20 px-10">
          <div className="block sm:flex justify-between items-center mt-7 text-center sm:text-start">
            ...
            <button className="py-4 px-6 bg-[#f1f5f5] border-2 rounded-full mt-5 sm:mt-0">
              View All
            </button>
          </div>
          <div className="sm:grid block lg:grid-cols-3 grid-cols-2 gap-x-5 gap-y-5 mt-10 justify-items-center max-w-[1300px] mx-auto">
            <div className="col-span-1 bg-[#fff]  flex justify-center items-center text-center rounded-3xl p-10 shadow-lg max-w-[400px]">
              <div>
                ...
                <h1 className="font-medium font-sans text-2xl mt-8">
                  BOX & RELAX
                </h1>
                <p className=" mt-3">
                  We realize ideas from simple to complex,every become easy to
                  use
                </p>
              </div>
            </div>
            <div className="col-span-1 bg-[#fff]  flex justify-center items-center text-center rounded-3xl p-10 shadow-lg max-w-[400px] my-10 sm:my-0">
              <div>
                ...
                <p className=" mt-3">
                  Flight booking in your mind looking for cheap
                </p>
              </div>
            </div>
            <div className="lg:col-span-1 col-span-2 bg-[#fff]  flex justify-center items-center text-center rounded-3xl p-10 shadow-lg max-w-[400px]">
              <div>
                ...
                <p className=" mt-3">
                  Find cheap flight,travel great list ideals from over travel
                  providers
                </p>
              </div>
            </div>
      ...
      <section className="my-20">
        <div className="container mx-auto px-10">
          <h1 className="text-center text-4xl font-semibold text-[#232730] mb-12">
            Why Flight Ticket
          </h1>
          <div className="grid lg:grid-cols-4 grid-cols-2 mt-20 gap-y-20 justify-items-center">
            <div className="col-span-1 text-center max-w-[300px]">
              ...
              <h1 className="text-lg font-semibold mt-10 text-[#59595b]">
                Hassle-Free
              </h1>
              <p className="mt-3 text-[#b4b4b7]">
                Make a transaction from anywhere at any time, from desktop,
            ...
            <div className="col-span-1 text-center max-w-[300px]">
              ...
              <p className="mt-3 text-[#b4b4b7]">
                Be more flexible with various payment methods from ATM, Bank
                Transfer, Credit Card, and Internet Banking, to Cash.
              </p>
            </div>
            <div className="col-span-1 text-center max-w-[300px]">
              <div className=" flex justify-center  max-h-[140px]">
              ...
              <p className="mt-3 text-[#b4b4b7]">
                Security and privacy of your online transaction are protected by
                RapidSSL authorized technology. Receive instant confirmation and
                e-ticket or voucher directly in your email.
              </p>
            </div>
          </div>
        </div>
