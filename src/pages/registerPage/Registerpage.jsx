...
const Registerpage = () => {
  ...
  return (
    <div className='container'>
      <div className='wrapper-form-login flex flex-col items-center p-[75px] min-h-[100vh]' style={{background: 'linear-gradient(121.74deg, #2c4284 .97%, #3e5cb8 54.61%, #4a6fde 99.48%)'}}>
        <a href="/" className='cursor-pointer no-underline mb-[50px]'>
        ...
        <div className='login-form-box w-[590px] overflow-hidden text-base rounded-md'>
            ...
            <form className='login-form'>
              ...
              <div className='country-phone flex mb-[20px]'>
                <div className='flex-[1] mb-0'>
                  <label className='label-country text-[#59595b] text-[0.875rem] font-normal mb-[0.5em] block'>
                    Country
                  </label>
                  <div className='country-box relative outline-none cursor-default border-none box-border clear-both text-base text-left'>
                    <div className='country-picker pl-0 bg-transparent rounded-none border-b border-solid border-[#dedede] pr-[32px] text-[#59595b] shadow-none h-[32px] text-[14px] leading-[20px] font-normal w-full max-w-full inline-flex items-center justify-start relative align-top'>
                      ...
                      placeholder='+62'
                      tabIndex="0"
                      className='picker-country-input w-0 text-[#59595b] absolute p-0 m-0 outline-none border-none touch-manipulation'
                      />
                ...
                <div className='phone-number-box ml-[20px] mb-0 flex-[3]'>
                  <label className='label-phone text-[#59595b] font-normal text-[0.875rem] mb-[0.5em] block'>
                    Mobile Number
                  </label>
              ...
              <div className='term-condition px-[70px] py-[30px]'>
                <p className='leading-[20px] text-[#9a9a9d] text-center text-[12px] font-normal m-0 p-0'>
                  By clicking th "Sign Up" button, you have agreed to rules, restrictions and <span>
          ...
          <div className='bg-[#f7f7f7] border-b-0 border-r-0 border-l-0 p-[30px] rounded-b-md text-[#59595b] block text-center'>
            <p className='text-[14px] leading-[20px] font-normal'>Already an Airsanz member? <span className='ml-[3px]'><a href='/' className='cursor-pointer text-[#59595b] font-bold'>Login</a></span></p>
          </div>
        </div>
      </div>
    </div>
