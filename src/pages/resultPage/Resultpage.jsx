                ...
                <div className='flight-header flex py-[10px] mx-[10rem] items-center'>
                    <div className='flight-header-item flex flex-1'>
                        ...
                        <div className='description'>
                            ...
                            <p className='text-base font-light'><span>KNO -JKT</span><span className='px-1'>  |  </span>  Wed, 24 Nov</p>
                        </div>
                    </div>
                    <div className='flight-header-item'>
                        <button onClick={() => setShowForm(!showForm)} onCLi className='text-base text-blue-600 rounded-md border bg-transparent border-blue-600 border-solid flex w-full py-2 px-6 hover:bg-blue-700 hover:text-white'>Change Search</button>
                    </div>
                </div>
            ...
            <div className='flex flex-col py-[10px] mx-[15rem] bg-white rounded-md'>
                <div className='flex flex-row justify-between items-center border-b border-gray-300'>
                    <div className='mx-5 py-2'>
                        ...
                        <p className='text-base font-light pb-2'> Wed 24 Nov 2022 <span> | </span>  1 Traveler</p>
                    </div>
                    <div className='mx-8'>
                        <button className='text-base font-medium text-gray-500 rounded-md w-full py-2 px-6 bg-gray-200 hover:bg-gray-100' onClick={() => setShowDate(!showDate)}>Change Date</button>
                    </div>
